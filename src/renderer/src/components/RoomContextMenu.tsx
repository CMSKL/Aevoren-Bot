...
import { BellIcon, CopyIcon, EyeIcon, EyeOffIcon, FolderIcon, PencilIcon, PinIcon, TrashIcon } from "./Icons";
...
export function RoomContextMenu({ room, x, y, onClose, onPin, onUnread, onRename, onCopyId, onHide, onArchive, onDelete }: Props): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className="bot-context-section">
        <MenuItem icon={<PencilIcon />} onSelect={() => select(onRename)}>重命名聊天</MenuItem>
      </div>
      <div className="bot-context-section">
