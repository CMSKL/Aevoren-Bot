...
| --- | --- | --- | --- |
| Aevoren Bot application icon | `resources/icon.png`, `resources/icon.icns`, `resources/AppIcon.icon/` | Restored from the project's private legacy archive and horizontally mirrored for the approved left-facing direction in Apple Icon Composer without changing its scale, palette, or composition parameters. Final 1024px PNG SHA-256: `a871716880806806a03199f4625772838a43387f9a565462cc96cd257091100f`; Icon Composer layer SHA-256: `0fa442a952bca676ecbb3d17ea385d0713f60870bd5882d5fc47b4bd137bfe5e`; ICNS SHA-256: `2dbb997197334b95bd526161772949f5f64cf64c15b57ccd77105b18931c22f9` | The repository maintainer explicitly directed this legacy project asset to be redistributed with Aevoren Bot; the attestation below records that project-level permission. Independent authorship and trademark clearance remain legal-review items |
| Public product overview screenshot | `docs/assets/aevoren-bot-overview.png` | Captured from an isolated Electron run using the locally authenticated Codex CLI and GPT-6-Astra, with a fresh temporary database and a synthetic user prompt. No account identifier, key, private transcript, or personal path is visible. SHA-256: `fc095e56bfeacc07fb8d98e303b3ae52ea341f26abc70612eb463918b7d38d3a` | Safe for public README and portal display; regenerate if the public UI changes materially or the shown model/provider is no longer representative |
