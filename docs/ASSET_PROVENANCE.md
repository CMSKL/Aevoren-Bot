...
| Public product overview screenshot | `docs/assets/aevoren-bot-overview.png` | Captured from the deterministic Fake Provider Smoke flow using synthetic Bot/profile content; no real account, key, transcript, or personal path | Safe for public README and portal display; regenerate if the public UI changes materially |
